...
\begin{table}
  \caption{Configuration of generators in Experiments}\label{table:generator-setting}
  \centering
  \begin{tabular}{l|c}
    \toprule
    \makecell{Latent distribution $p_{s,\kappa}(\bm{z})$
    \\$s\in \Ss, \kappa=1, 2, \cdots, K $} & Standard Gaussian \\
    \hline
    Number of flow blocks & $4$ \\
    \hline
    Non-linear mapping $\bm{m}_a$, $\bm{m}_b$ & \makecell{Multiple
                                                layer perception, \\
...
\begin{table}
  ...
  \begin{tabular}{l|l|c|c|c|c}
    ...
    \cline{3-6}
                           ...
                           && \makecell{15dB} &  \makecell{20dB} &  \makecell{25dB} & \makecell{30dB}  \\
    \midrule
    \multirow{3}{*}{GMM-HMM}
